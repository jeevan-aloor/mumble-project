...
function Header() {
  ...
  console.log(navigate,"naviigtee")
  return (
      ...
      <Container fluid>
        ...
        <Navbar.Collapse id="navbarScroll">
          ...
          >
            ...
            {/* <Link style={{  color: "var(--background2)"  }} to="/aboutus">About Us</Link> */}
          ...
          <Form onSubmit={(e)=>e.preventDefault()} className="d-flex">
            <InputGroup className="mb-3">
              ...
              <Popup trigger={<button style={{background:"none",border:"none",color:"white"}}> <img
                style={{
                  height: "3rem",
                  marginTop: "0.8rem",
                  marginLeft: "1rem",
